...
export const validateConfigJSON = (
  ...
  try {
    ...
    if (
      ...
      return {
        valid: false,
        error: "Field 'showBlockKitDebug' must be a boolean",
      };
    }
    ...
    if (
      ...
      return {
        valid: false,
        error: "Field 'withoutWrapper' must be a boolean",
      };
    }
    ...
    if (
      ...
      return {
        valid: false,
        error: "Field 'theme' must be 'light', 'dark', or undefined/null",
      };
    }
    ...
    if (parsed.data) {
      ...
      if (channels !== undefined && !Array.isArray(channels)) {
        return {
          valid: false,
          error: "Field 'data.channels' must be an array",
        };
      }
